...
class Autobreeding : public GACrossbreeding <NetworkPopulation, NetworkGenome> {
public:

	Autobreeding(double value) {
...
void Autobreeding::cross(NetworkPopulation *population, NetworkGenome* parentA, NetworkGenome *parentB){
